...
<path d="M298.74 94.712V92.212H296.24H263.604V5V2.5H261.104H248H245.5V5V105.368V107.868H248H296.24H298.74V105.368V94.712Z" stroke={theme.palette.mode === 'light'?"black":"white"} stroke-width="5"/>
  ...
  return (
    ...
    <PsychologyAltTwoToneIcon sx={{ fontSize: 100, }} />
    </Box>
    ...
    <Grid item xs={12} style={{alignItems:'center', justifyContent:'center'}}>
        ...
        <Box className="introText">
          ...
          <Typography variant="h1"> Guess the _______</Typography>
          </Grow>
          {/* <Grow in={checked} style={{ transformOrigin: '0 0 0' }}
      ...
      <Box className='subTitle'><Typography  variant="subtitle1"><Box className='subTitleUIUX'>Test your knowledge...</Box></Typography></Box>
