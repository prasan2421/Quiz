...
export default function Layout({ children, home }: {
  ...
  const drawerHeader = (
    <Box sx={{ padding: '20px', height: '7rem', display: 'flex', justifyContent: 'space-between' }}>
    ...
    <StyledEngineProvider>
      <Box sx={{ display: 'flex' }} >
        ...
        <AppBar
          position="fixed"
          sx={{
            background: 'transparent', color: "inherit", boxShadow: 'none', width: '100%'
        ...
        >
          <Toolbar>
            ...
            <Alert severity="info" sx={{ justifyContent: 'center', display: 'flex', borderRadius: '15px', width: 'max-content' }}>Game under construction !!</Alert>
